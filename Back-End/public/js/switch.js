...
document.addEventListener('DOMContentLoaded', function () {
  ...
  switchTheme.addEventListener('change', function () {
    ...
    elementsToToggle.text.forEach((p) =>
      p.classList.toggle('light', isLightMode)
    );
    elementsToToggle.icons.forEach((icon) =>
      icon.classList.toggle('light', isLightMode)
    );
    elementsToToggle.filterButtons.forEach((button) =>
      button.classList.toggle('light', isLightMode)
    );
    elementsToToggle.imgTitle.forEach((title) =>
      title.classList.toggle('light', isLightMode)
    );
